...
const Blogs = () => {
    return (
        <div className='mx-auto container'>
            ...
            <div className='ml-2 border-l border-yellow-700 px-10 hilight'>
                <div>
            ...
            <div className='ml-2 border-l border-yellow-700 px-10 mt-16 hilight'>
                <div>
